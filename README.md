...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/small-grass-990d)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/small-grass-990d
```

A live public deployment of this template is available at [https://small-grass-990d.templates.workers.dev](https://small-grass-990d.templates.workers.dev)
